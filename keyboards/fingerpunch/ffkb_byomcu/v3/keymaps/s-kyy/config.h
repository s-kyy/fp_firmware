...
// =============================================
    ...
    #define FP_LAYER_LIGHTING_HUE_1 FP_HSV_MELON 
    #define FP_LAYER_LIGHTING_HUE_2 HSV_GOLDENROD
    #define FP_LAYER_LIGHTING_HUE_3 FP_HSV_LAVENDER
    #define FP_LAYER_LIGHTING_HUE_4 HSV_CORAL
    ...
    #define FP_LAYER_LIGHTING_MODE_0 RGB_MATRIX_JELLYBEAN_RAINDROPS
    ...
    #define FP_LAYER_LIGHTING_MODE_1 RGB_MATRIX_BAND_PINWHEEL_VAL
    #define FP_LAYER_LIGHTING_MODE_2 RGB_MATRIX_BAND_PINWHEEL_SAT
    #define FP_LAYER_LIGHTING_MODE_3 RGB_MATRIX_BAND_PINWHEEL_VAL
    #define FP_LAYER_LIGHTING_MODE_4 RGB_MATRIX_BAND_PINWHEEL_SAT
    #define FP_LAYER_LIGHTING_MODE_5 RGB_MATRIX_SOLID_REACTIVE_WIDE
