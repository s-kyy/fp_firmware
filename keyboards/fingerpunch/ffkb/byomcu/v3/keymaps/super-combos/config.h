...
#define FP_POINTING_SCROLLING_LAYER 3 //INACCESSIBLE
...
// RGB config
// =============================================
#ifdef RGB_MATRIX_ENABLE //update vial.json if using it. 
    #define FP_STARTUP_ANIMATION_DISABLE
    #define FP_LAYER_LIGHT_MODE RGB_MATRIX_ALPHAS_MODS
    #define RGB_DISABLE_WHEN_USB_SUSPENDED
    #define RGB_MATRIX_DEFAULT_SPD 110
    #define RGB_MATRIX_DEFAULT_VAL 70 // Sets the default brightness value, if none has been set
    ...
    // #define FP_LAYER_LIGHTING_HUE_1 HSV_WHITE  hsv_orange  
    ...
    #define FP_LAYER_LIGHTING_MODE_2 RGB_MATRIX_BREATHING
    #define FP_LAYER_LIGHTING_MODE_3 RGB_MATRIX_BREATHING
    #define FP_LAYER_LIGHTING_MODE_4 RGB_MATRIX_BREATHING
    #define FP_LAYER_LIGHTING_MODE_5 RGB_MATRIX_BREATHING
    #define FP_LAYER_LIGHTING_MODE_6 RGB_MATRIX_BREATHING
    // #define FP_LAYER_LIGHTING_MODE_6 RGB_MATRIX_SOLID_MULTISPLASH
